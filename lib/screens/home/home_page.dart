                    ...
                    padding: const EdgeInsets.all(16.0),
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          var toiletDist = double.parse(_toiletDistanceController.text);
                          var toilet = Toilet(name: toiletName, point: toiletPoint, distance: toiletDist);
